...
--
-- Host: localhost:3306
-- Generation Time: Mar 29, 2023 at 01:33 PM
...
--
DELIMITER $$
CREATE TRIGGER `multidelete` BEFORE DELETE ON `tb_lelang` FOR EACH ROW DELETE FROM history_lelang WHERE id_lelang = OLD.id_lelang
$$
DELIMITER ;
...
(29, 'Riszz', 'oji', '$2y$10$e9vyhjVGiCEko8vyl0tj2eFbNrpXE3F/HnUorZ/XEZlFiApwOdpyK', '8578557564'),
(30, 'Rizz', 'riski', '$2y$10$e9vyhjVGiCEko8vyl0tj2eFbNrpXE3F/HnUorZ/XEZlFiApwOdpyK', '85718557564');
...
(3, 'ji2', 'oji1', '$2y$10$e9vyhjVGiCEko8vyl0tj2eFbNrpXE3F/HnUorZ/XEZlFiApwOdpyK', 'petugas', 2);
